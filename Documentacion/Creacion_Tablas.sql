...
CREATE TABLE PEDIDO_ARTICULO_FILTRO
(
	Id	INT  NOT NULL IDENTITY(1,1),
	...
	CONSTRAINT FK_IdPedidoArticulo_PEDIDO_ARTICULO_FILTRO FOREIGN KEY (IdPedidoArticulo) REFERENCES PEDIDO_ARTICULO (Id),
...
--Los password de Prueba son: 123
('CLIENTE1','202cb962ac59075b964b07152d234b70', NULL,'DEVOTO (1)','1','RAZ. SOC. 1',0,'LUNES y VIERNES','DIRECCION 1','1','CONTACTO CLIENTE 1','1','EMAIL1@EMAIL.COM','CLIENTE1.jpg',1),
('CLIENTE2','202cb962ac59075b964b07152d234b70', NULL,'DEVOTO (2)','2','RAZ. SOC. 2',10,'MARTES y JUEVES','DIRECCION 2','2','CONTACTO CLIENTE 2','2','EMAIL2@EMAIL.COM','CLIENTE2.jpg',1),
('CLIENTE3','202cb962ac59075b964b07152d234b70', NULL,'SIGLO XXI (1)','3','RAZ. SOC. 3',20,'MIERCOLES','DIRECCION 3','3','CONTACTO CLIENTE 3','3','EMAIL3@EMAIL.COM','CLIENTE3.jpg',1),
('CLIENTE4','202cb962ac59075b964b07152d234b70', NULL,'SIGLO XXI (2)','4','RAZ. SOC. 4',30,'MIERCOLES','DIRECCION 4','4','CONTACTO CLIENTE 4','4','EMAIL4@EMAIL.COM','CLIENTE4.jpg',1),
('CLIENTE5','202cb962ac59075b964b07152d234b70', NULL,'DISCO (1)','5','RAZ. SOC. 5',40,'MIERCOLES','DIRECCION 5','5','CONTACTO CLIENTE 5','5','EMAIL5@EMAIL.COM','CLIENTE5.jpg',1);
